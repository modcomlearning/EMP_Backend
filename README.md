...
To Protect routes with a Token, create a Folder named middleware and inside create a File named verifyToken.js and write below code.
...
In routes.js add this requirement

        const verifyToken = require('../middleware/verifyToken');


Then in any of your CRUD routes, and VerifyToken like below. Note we have added verifyToken in below route, when accessing this route you will need to provide a Bearer Token.
